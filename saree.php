...
<head>
   ...
   <title>Saree Collection - Crafty's Shelf</title>
...
<section class="products">
   <h1 class="title">Saree Collection</h1>
      ...
      <?php if (count($products) > 0): ?>
         <?php foreach ($products as $product): ?>
            <div class="box">
               ...
               <a href="saree.php?wishlist=<?= $product['id']; ?>" class="option-btn">Add to Wishlist</a>
               <a href="saree.php?cart=<?= $product['id']; ?>" class="btn">Add to Cart</a>
            </div>
         <?php endforeach; ?>
      <?php else: ?>
         <p class="empty">No sarees available now!</p>
      <?php endif; ?>
