...
// Redirect to login if user not logged in for wishlist/cart actions
...
<head>
   ...
   <title>Jewellery Collection - Crafty's Shelf</title>
...
<section class="products">
   <h1 class="title">Jewellery Collection</h1>
      ...
      <?php if (count($products) > 0): ?>
         <?php foreach ($products as $product): ?>
            <div class="box">
               ...
               <a href="jewellery.php?wishlist=<?= $product['id']; ?>" class="option-btn">Add to Wishlist</a>
               <a href="jewellery.php?cart=<?= $product['id']; ?>" class="btn">Add to Cart</a>
            </div>
         <?php endforeach; ?>
      <?php else: ?>
         <p class="empty">No jewellery products found.</p>
      <?php endif; ?>
   </div>
</section>
